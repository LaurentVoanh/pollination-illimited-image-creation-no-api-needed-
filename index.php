    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.startProcess = function() {
                ...
                // Intervalle pour le processus de création des images
                setInterval(fetchNextImage, 30000); // Change image every 30 seconds

                // Intervalle pour le changement des slides
